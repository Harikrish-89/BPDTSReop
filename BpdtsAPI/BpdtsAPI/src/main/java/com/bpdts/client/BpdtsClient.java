...
public class BpdtsClient {
	...
	public BpdtsClient(@SuppressWarnings("exports") final HttpClient httpClient) {
	...
	private List<User> getUsersFromApi(final String path)
		...
		HttpResponse<String> response = httpClient.send(usersRequest, BodyHandlers.ofString());
